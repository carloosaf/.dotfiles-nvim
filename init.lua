...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      -- Open files in a nice file explorer
      require('mini.files').setup {
        vim.keymap.set('n', '<leader>.', '<cmd>lua MiniFiles.open()<cr>', { desc = 'Opens file explorer' }),
      }

      -- Add/remove/replace pairs
      require('mini.pairs').setup()

      -- Show the current tab and buffer number
